...
const mapDestructuring = (...properties) => ({ type: 'MapDestructuring', properties });

const array = (...values) => ({ type: 'ArrayLiteral', values });

const arrayDestructuring = (...values) => ({ type: 'ArrayDestructuring', values });
...
const negate = (expr) => ({ type: 'NegatedExpression', target: expr });
