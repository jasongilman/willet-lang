...
AssignmentTarget
  ...
  / ArrayDestructuring
  / ValueSequence
  / s:Symbol { return { type: 'Reference', symbol: s}; }
...
ValueReference = Literal / SymbolReference
...
PropertyAssignment
  ...
  / s:SymbolReference { return { type: "Property", key: s.symbol, value: s }; }
